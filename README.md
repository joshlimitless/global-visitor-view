...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/global-visitor-view)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/global-visitor-view
```

A live public deployment of this template is available at [https://global-visitor-view.templates.workers.dev](https://global-visitor-view.templates.workers.dev)
